...
clear
figlet Tmetasploit
toilet -f future COOLBOYS --gay
echo "
"
echo "       -{ TMetasploit  } "
echo "       -{ coded by krissh Kumar  } "
echo ""
echo "=>I am not responsble for any damage use it in Your Own Risk"
echo ""
echo "-------------------------------------------"
echo "Are You Sure Want To Install Tmetasploit ?"
echo "-------------------------------------------"
echo ""
...
curl -LO https://raw.githubusercontent.com/krisshkumar/tmetasploit/master/database.yml
...
echo "Coded By Krissh Kumar"
echo "Indian Jokers are not funny"
echo "TEAM JOKERS "
echo " =====COOLBOYS===== "
echo "

"
echo " contact me : contactuscoolboys@gmail.com"
